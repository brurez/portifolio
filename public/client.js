...
var bind = __webpack_require__(/*! ./helpers/bind */ 2);
var isBuffer = __webpack_require__(/*! is-buffer */ 13);
...
var normalizeHeaderName = __webpack_require__(/*! ./helpers/normalizeHeaderName */ 15);
...
var utils = __webpack_require__(/*! ./../utils */ 0);
var settle = __webpack_require__(/*! ./../core/settle */ 16);
var buildURL = __webpack_require__(/*! ./../helpers/buildURL */ 18);
var parseHeaders = __webpack_require__(/*! ./../helpers/parseHeaders */ 19);
var isURLSameOrigin = __webpack_require__(/*! ./../helpers/isURLSameOrigin */ 20);
var createError = __webpack_require__(/*! ../core/createError */ 5);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(/*! ./../helpers/btoa */ 21);
...
var enhanceError = __webpack_require__(/*! ./enhanceError */ 17);
...
var _typed = __webpack_require__(/*! typed.js */ 9);
...
var _scrollDevagar = __webpack_require__(/*! ./scrollDevagar */ 30);
...
var interval = setInterval(function () {
  if (isScrolledIntoView(document.querySelector('.skillbar'))) {
    ...
    try {
      for (var _iterator = document.querySelectorAll('.skillbar')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
exports.default = function () {
  document.querySelector('#form').addEventListener('submit', function (e) {
    e.preventDefault();
    var submitHtml = document.querySelector('#submit').innerHTML;
    document.querySelector('#submit').innerHTML = '<i class="fa fa-spinner fa-spin"></i> Enviando...';
    var data = {
    ...
    function setError(errorMsg) {
      document.querySelector('#form-msg').innerHTML = '<div class="destaque erro">\n            ' + errorMsg + ' <i class="fa fa-thumbs-o-down"></i>\n           </div>';
      document.querySelector('#submit').innerHTML = submitHtml;
    }
  });
};
...
module.exports = __webpack_require__(/*! ./lib/axios */ 12);
...
var utils = __webpack_require__(/*! ./utils */ 0);
var bind = __webpack_require__(/*! ./helpers/bind */ 2);
var Axios = __webpack_require__(/*! ./core/Axios */ 14);
...
var createError = __webpack_require__(/*! ./createError */ 5);
